...
class TestLHC {
    ...
    void test3() {
        ...
        assertEquals(card.getPerson(), visitor);
    ...
    void test4() {
        ...
        assertEquals(card.getPerson(), employee);
    ...
    void test5_test6() {
        ...
        assertEquals("3", crazyPerson.toString());
    ...
    void test14() {
        ...
        final List<IExperiment> experiments = detector.getExperiments(new Researcher(Person.getRandomName()));
        assertEquals(200000, experiments.get(0).getBlocks().length);
        assertEquals(10, experiments.get(0).getBlocks()[0].getStructure().length());
    ...
    void test15() {
        ...
        detector.loadExperimentsFromDB();
        final List<IExperiment> experiments = detector.getExperiments(new Researcher(Person.getRandomName()));
        final List<IExperiment> filteredExperiments = experiments.stream().filter(IExperiment::isHiggsBosonFound).collect(Collectors.toList());
